...
What is Perpertual powers of Tau ?

Innovations in Trusted Setup : Optimistic Pipelining

Security Considerations in Trusted Setup

- Exposing Discrete Log Relation
- Cheon’s attack
- Memory management
- Degenerative contributions
...
In this process, trust in atleast one of the participants is paramount to ensure the efficacy of the setup. This gives rise to the term 'trusted setup.' 
...
1. https://blog.pantherprotocol.io/a-guide-to-understanding-trusted-setups/
...
$$
(\tau * G_1, \tau ^2 * G_1, \tau^3 *  G_1, ... , \tau ^ m * G_1 \ ; \ \tau * G_2, \tau ^2 * G_2, \tau^3 *  G_2, ... , \tau ^ n * G_2 \  )
$$
...
## **Innovations in Trusted Setup :** [Optimistic Pipelining](https://ethresear.ch/t/accelerating-powers-of-tau-ceremonies-with-optimistic-pipelining/6870)
...
### 1. E**xposing discrete Log relation**
...
During the trusted ceremony, it is possible for an attacker to use a degenerative contribution to erase the setup thus undermining the contributions of previous participants. Thus, it important that the verifier checks if the contributor has well formed public parameters, non-degenrative updates & that the latest contribution to the ceremony builds on the work of the preceding participants.

Here’s another article explaining the security considerations of Trusted Setup ceremonies : https://research.nccgroup.com/2020/06/24/security-considerations-of-zk-snark-parameter-multi-party-computation/
...
To ensure a trustworthy Trusted Setup : Audit Your Trusted Setup, Use Reliable and Verified Code, Follow Best Security Practices, Stay Informed !